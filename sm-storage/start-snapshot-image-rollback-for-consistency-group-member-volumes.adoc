...
+
** Si l'un des volumes membres sélectionnés est associé à plusieurs objets de capacité réservée qui stockent des images instantanées, la boîte de dialogue *capacité de révision* s'affiche. Accédez à <<TASK_3CC5A20F26E44B9DBDDBCF422EDBBB4C,Étape 2 : examiner la capacité>>.
** Si aucun des volumes membres sélectionnés n'est associé à plusieurs objets de capacité réservée qui stockent des images instantanées, la boîte de dialogue *Modifier la priorité* s'affiche. Accédez à <<TASK_2C49B5B3933341D1BA737F00EBBC1698,Étape 3 : modifier la priorité>>.
...
. Cliquez sur *Suivant* et allez à <<TASK_2C49B5B3933341D1BA737F00EBBC1698,Étape 3 : modifier la priorité>>.
+
