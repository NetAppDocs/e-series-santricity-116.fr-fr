...
Lorsque le langage SAML est activé, les utilisateurs ne peuvent pas détecter ni gérer le stockage de cette baie à partir des interfaces SANtricity Unified Manager ou SANtricity Storage Manager.
